...
key4 = hex(int(key1, 16) ^ int(key2, 16) ^ int(key3, 16))
flag1 = (int(key4, 16) ^ int('04ee9855208a2cd59091d04767ae47963170d1660df7f56f5faf', 16)) 
print(unhexlify(format(flag1, 'x')))